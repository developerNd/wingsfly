...
const Task = () => {
    const leaderboardData = [
        { id: 1, rank: 1, userName: "task", storeName: "Sujal Restaurant...", points: 30, imageUrl: "https://randomuser.me/api/portraits/men/32.jpg", isYou: true },
        ...
        <View style={styles.container}>
            ...
            <View style={styles.content}>
                ...
                <View style={styles.columnLabels}>
                    <Text style={styles.rankLabel}>S.NO</Text>
                    <Text style={styles.userNameLabel}>TASK NAME</Text>
