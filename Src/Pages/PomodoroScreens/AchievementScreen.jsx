    ...
    <SafeAreaView style={styles.container}>
      ...
      <View style={styles.content}>
        ...
        <View style={styles.progressContainer}>
          ...
          {/* NEW: Clock Line SVG - Sharp indicator at 75% progress position */}
          <ClockLineSvg2 
            width={WP(18)} 
            height={WP(19.2)} 
          ...
          <View style={styles.centerContent}>
            ...
            <View style={styles.taskInfo}>
              <View style={styles.taskCountContainer}>
                <Text style={styles.taskCount1}>{completedTasks}</Text>
        ...
        {/* Task Statistics with Background Image */}
        <View style={styles.taskStatsContainer}>
          ...
          <View style={styles.taskStatsOverlay}>
            ...
            <View style={styles.statItem}>
              ...
              <Text style={styles.statNumber}>{completeTasks}</Text>
            </View>
          </View>
        </View>
      </View>
...
const styles = StyleSheet.create({
  ...
  // NEW: Clock Line Indicator - Sharp indicator at 75% progress position (top area)
  clockLineIndicator: {
    position: 'absolute',
    top: WP(14.6), // Position at the top where 75% would be
