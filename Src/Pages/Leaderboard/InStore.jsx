...
const LeaderboardItem = ({ rank, userName, storeName, points, imageUrl, isYou }) => {
    return (
        <View style={[styles.itemContainer, isYou && styles.highlightedItem]}>
            <Text style={[styles.rankText,{color:isYou?"#3366FF":"#000"}]}>{rank}</Text>
            <View style={styles.profileContainer}>
                ...
                <View style={styles.userInfo}>
                    <Text style={[styles.userName, { color: isYou ? "#3366FF" : "#000" }]}>{userName}{isYou && " You"}</Text>
                </View>
                <View style={styles.userInfo}>

                    <Text style={[styles.storeName, { color: isYou ? "#3366FF" : "#000" }]}>{storeName}</Text>
                </View>
            </View>
