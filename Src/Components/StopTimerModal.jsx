...
const StopTimerModal = ({visible, onCancel, onConfirm}) => {
  return (
    <Modal
      visible={visible}
      transparent={true}
        ...
        <View style={styles.modalContainer}>
          ...
          <View style={styles.messageContainer}>
            <Text style={styles.modalMessage}>
              ...
              <Text style={styles.warningText}> All progress will be lost </Text> 
          ...
          <View style={styles.buttonContainer}>
            ...
            <TouchableOpacity
              ...
              onPress={onConfirm}
              activeOpacity={0.7}>
              <Text style={styles.confirmButtonText}>Stop & Reset</Text>
            </TouchableOpacity>
          </View>
        </View>
      </View>
